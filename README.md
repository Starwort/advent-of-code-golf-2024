...
Day | AWK | Bash | C (GCC) | C++ (GCC) | Julia | Python | Python (No Whitespace) | Python (Orthoplex) | Ruby
--: | --- | --- | --- | --- | --- | --- | --- | --- | ---
...
2 | [148 - shanethegamer](./solutions/2/awk) | [156 - shanethegamer](./solutions/2/bash) | - | - | - | [164 - krowten024nabru](./solutions/2/python) | - | - | -
